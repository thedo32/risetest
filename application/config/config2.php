...
|
*/
$config['base_url'] = 'https://www.kopibatigo.id';
...
|
*/
$config['encryption_key'] = 'xyzt3mxyzt3s!ng';
...
|
*/
$config['sess_driver'] = 'custom_database';
...
$config['cookie_domain'] = '.kopibatigo.id'; // Note the leading dot
$config['cookie_path']		= '/';

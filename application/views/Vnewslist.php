...
<body class="bg-body">
    ...
    <h6>You're Logged in' as: <a href="<?php echo base_url('home'); ?>">Admin</h6>
    <?php elseif ($this->session->userdata("name") != Null ):?>
    <h6>You're Logged in' as: <a href="<?php echo base_url('home'); ?>"><?php echo $this->session->userdata("name"); ?></h6>
    <?php endif; ?>

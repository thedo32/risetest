                ...
                <table class=admin-table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('news/edit/padang/' . $padang_list['id']); ?>">Edit</a><p>
                                <a href="<?php echo site_url('news/delete/padang/' . $padang_list['id']); ?>" onclick="return confirm('Are you sure you want to delete this news?');">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
							 ...
							 <?php foreach ($padang as $index => $padang_list): ?>
								<td>
									<div class="newsbox">
										 ...
										 <a href="<?php echo site_url('padang/view/' . $padang_list['slug']); ?>" data-toggle="tooltip" title="<?php echo $padang_list['title']; ?>"><img src= "<?php echo base_url($padang_list['cover']);?>" height="280" width="280" class=news-imgthumb ></a>

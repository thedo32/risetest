...
<body class="bg-body">
	...
	$whatsappLink = "https://wa.me/62811663504?text=" . urlencode("Halo Kupi Batigo, Saya $name tertarik untuk memesan $pesanan");
	...
	<table class=read-table>
		<tbody>
			...
			<tr>
				<td><div class=slideshow-container-post><img src="<?php echo base_url($painan->cover); ?>" height=150% width=150% alt="Cover Image"></div></td>
			</tr>
			<!-- <tr>

...
<body class="bg-body">
	...
	<div class=h10> 
		<a href="https://en.kopibatigo.id/taluak">ENG</a><br>
							 ...
							 <?php foreach ($taluak as $index => $taluak_list): ?>
								<td>
									<div class="newsbox">
										 ...
										 <a href="<?php echo site_url('taluak/view/' . $taluak_list['slug']); ?>" data-toggle="tooltip" title="<?php echo $taluak_list['title']; ?>"><img src= "<?php echo base_url($taluak_list['cover']);?>" height="280" width="280" class=news-imgthumb ></a>

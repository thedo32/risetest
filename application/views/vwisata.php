...
<body class="bg-body">
    ...
    <div class=shadowboxmin><h1>Desa Wisata Taluak Buo</h1></div> 
        ...
        <div class=row>
            <div class=table-responsive>
				<table class=news-table>
					<tbody>
					<tr>
						<td><div class="card-title"><h5><?php echo set_value('title', $wisata->title); ?></h5></div></td>
					</tr>
					<tr>
						<td><div class="d-flex my-2"><?php echo htmlspecialchars_decode(set_value('text', $wisata->text)); ?></div></td>
					</tr>
				</tbody>		
			</table>
		</div>

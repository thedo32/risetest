        ...
        <div class=row>
            <div class=table-responsive>
                ...
                <table class=admin-table>
                    ...
                    <tbody>
                        <?php if (is_array($wisata)): ?>
                        <?php foreach ($wisata as $wisata_list): ?>
                        <tr>
                            <td>
                               <a href="<?php echo site_url('wisata/view/' . $wisata_list['slug']); ?>"><?php echo $wisata_list['title']; ?></a>
                            </td>
                            <td><?php echo character_limiter($wisata_list['text'],30); ?></td>
                            <td>
                                <a href="<?php echo site_url('news/edit/' . $wisata_list['id']); ?>">Edit</a><p>
                                <a href="<?php echo site_url('news/delete/' . $wisata_list['id']); ?>" onclick="return confirm('Are you sure you want to delete this news?');">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else: ?>
                ...
                <table class="news-table">
                    <tbody>					  
                        <?php if (is_array($wisata)): ?>
                        <tr>
							 <?php foreach ($wisata as $index => $wisata_list): ?>
								<td>
									<div class="newsbox">
										 <div class="sm-title"><a href="<?php echo site_url('wisata/view/' . $wisata_list['slug']); ?>" title="<?php echo $wisata_list['title']; ?>"><?php echo $wisata_list['title']; ?></a></div><p>
										 <a href="<?php echo site_url('wisata/view/' . $wisata_list['slug']); ?>" data-toggle="tooltip" title="<?php echo $wisata_list['title']; ?>"><img src= "<?php echo base_url("storage/app/public/images/logo/logo.png");?>" height="50" width="65" class=news-imgthumb ></a>
										 <p><?php echo character_limiter($wisata_list['text'], 20); ?>
									</div>
								</td>
								<?php if ($index % 2 != 0): ?>
									</tr><tr>
